...
from app.api.exceptions import DonateException
...
@router.get(
    '/',
    response_model=Optional[List[DonationDBSuperUser]],
...
async def get_all_user_donations(
    ...
    return await donation_crud.get_objs_by_user(session=session, user=user)
...
async def create_donation(
    ...
    try:
        ...
        raise DonateException('Средства уже распределены')
    return new_donation
